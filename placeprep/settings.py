"""
Django settings for placeprep project.
...
WSGI_APPLICATION = 'placeprep.wsgi.application'
...
if DATABASE_ENGINE in ('postgres', 'postgresql'):
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('POSTGRES_DB', 'placeprep'),
            'USER': os.getenv('POSTGRES_USER', 'placeprep'),
            'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'placeprep'),
